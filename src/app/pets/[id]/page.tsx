    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      {!hasPro && (
        <div className="bg-orange-50 p-6 border-x text-center">
          <p className="text-orange-700 font-bold">🔒 Unlock Pro Features</p>
          <p className="text-sm text-orange-600 mt-1">Wellness Score • Weight Tracker • Guardian System • Emergency Panel</p>
          <Link href="/upgrade?plan=pro" className="inline-block mt-3 bg-orange-500 text-white px-4 py-2 rounded-lg">Upgrade Now →</Link>
        </div>
      )}
