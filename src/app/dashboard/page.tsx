...
export default function Dashboard() {
  ...
  const firstPet = pets[0]; // Get the first pet for links
...
const dashStyles = `
  ...
  .vp-hero { position: relative; overflow: hidden; background: linear-gradient(160deg, #1a1410 0%, #120f0c 100%); border-bottom: 0.5px solid rgba(196,122,58,0.15); padding: 36px 24px 32px; }
  ...
  .vp-upgrade-banner { display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px; background: linear-gradient(135deg, #1f1508, #2a1a0a); border: 1px solid rgba(196,122,58,0.5); border-radius: 20px; padding: 28px 28px; }
